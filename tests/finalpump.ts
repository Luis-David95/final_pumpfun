...
import { Finalpump } from "../target/types/finalpump"
...
import keys = require("./keys/users.json")
import key2 = require("./keys/user2.json")
...
describe("bonding_curve", () => {
  ...
  const program = anchor.workspace.Finalpump as Program<Finalpump>;
      ...
      const tx = new Transaction()
        .add(
          ...
          await program.methods
            .initialize(1)
            .accounts({
              dex_configuration_account: curveConfig,
